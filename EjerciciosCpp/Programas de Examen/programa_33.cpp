...
//# Descripción: Programa que comprueba dígito uno a uno para después concatenarlo y convertir la cadena a entero
...
int main()
{
    ...
    do
    {
        ...
        cout << "\n Ingrese los dígitos uno a uno: ";cin >> digito;//cin >> digito;
        ...
        if (!num_ent_valido(digito))
        {
            ...
            cout << "\n Lo sentimos. El número ingresado no es un entero válido :'(" << endl;
            cout << "\n Ingresar siguiente dígito (s/n): "; cin >> respuesta;
        }
        else
        {
            //system("cls");
            ...
            /* Se guarda el dígito ingresado alctualmente y se concatena con el anterior:*/
            valor = digito_cad + digito;
            /*Se convierte este valor a un número entero siempre que válido se cumpla*/
    ...
    {
        //system("cls");
        cout << "\n El número total ingresado es: " << numero << endl;
